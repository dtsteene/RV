...
% Loosen float-placement defaults so figures sit closer to their text
% instead of getting promoted onto float-only pages.
...
% On float-only pages, pin figures to the top and let the slack sit at the
% bottom instead of getting distributed above and below.
\makeatletter
\setlength{\@fptop}{0pt}
