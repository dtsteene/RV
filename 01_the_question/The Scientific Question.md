...
Here "pressure-loading sweep" has a specific meaning. It is a set of repeated simulations of the same finite-element heart under different calibrated circulation states. The biventricular mesh, passive material law, fibre field, active-tension waveform, basal support, and cavity-volume coupling are held fixed. What changes is the zero-dimensional circulation calibration used to drive the same mechanics model through a range of RV pressure loads. The main sweep was designed as 16 nominal RV-pressure cases; the final high-resolution analysis uses the 15 completed cases. The achieved coupled pressures, not the nominal case names, define the analysis axis for the proxy tests: peak RV pressure spans roughly 31--88 mmHg while peak LV pressure remains comparatively stable, about 102--111 mmHg. The calibration chapter explains how those states are generated and why incomplete or imperfectly matched targets are treated as calibration limits rather than biological results.
